package com.placeapp.FavouriteService.config;
...
public class SwaggerConfiguration {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.placeapp.FavouriteService")).build().apiInfo(getUserInfo())
	...
	private ApiInfo getUserInfo() {
		...
		apibuilder.title("Favourite Jobs").version("V1.0")
		          .description("User Favourite jobs can be viewed and deleted")
				  .license("U80480@ust-global.com");
