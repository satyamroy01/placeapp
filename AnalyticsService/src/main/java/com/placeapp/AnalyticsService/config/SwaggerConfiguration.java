package com.placeapp.AnalyticsService.config;
...
public class SwaggerConfiguration {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.placeapp.AnalyticsService")).build().apiInfo(getUserInfo())
	...
	private ApiInfo getUserInfo() {
		...
		apibuilder.title("Analytics").version("V1.0")
		          .description("User Favourite jobs Analytics and applied Count")
